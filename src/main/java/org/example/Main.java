...
public class Main {
    public static void main(String[] args) throws Exception {
        ...
        String namespaceName = "axqntd0j0xmh";  //put your tenancy objectstorage namespace
        ...
        File body = new File("C:\\Users\\ralla\\OneDrive\\바탕 화면\\사진\\Osaka\\풍경\\IMG_1497.jpg");       //put your local file path
